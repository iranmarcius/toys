...
public final class DateToys {
  ...
  /**
   * Converte uma string contendo data e hora num formato específico para um objeto do tipo {@link Date}.
   *
   * @param dateTimeStr String contendo as informações de data e hora no formato
   *                    &quot;&lt;data&gt; &lt;hora&gt;&quot;. A data deverá estar no formato padrão da localidade
  ...
  /**
   * Retorna se um prazo está expirado baseado na data base e na validade informados conforme o momento atual.
   *
  ...
  /**
   * Retorna a igualdade de duas datas considerando os seguintes critérios:
   * <ul>
   *   <li>Caso as duas datas sejam nulas elas serão consideradas iguais.</li>
   *   <li>Caso apenas uma data seja nula ela será considerada maior que a outra.</li>
   *   <li>Caso nenhuma data seja nula elas serão comparadas pelos método {@link Date#compareTo(Date)}</li>
   * </ul>
   *
   * @param d1 Primeira data para comparação.
   * @param d2 Segunda data para comparação.
   * @return <code>int</code>
   */
